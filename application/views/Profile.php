            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class = "active text-primary bold">Update Profile</h3>
                            </div>
                        </div>
                        <hr>
                    </div>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class = "active text-primary bold">Update Password</h3>
                            </div>
                        </div>
                        <hr>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="update-form" action="/updatepass" method="post" role="form">
                                    <div class="form-group">
                                        <input type="password" name="new_password" id="new_password" tabindex="1" class="form-control" placeholder="New Password">
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="confirm_new_password" id="confirm_new_password" tabindex="1" class="form-control" placeholder="Confirm New Password">
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="current_password" id="current_password" tabindex="2" class="form-control" placeholder="Current Password">
                                        <?php if(form_error('current_password')){?> 
                                        <span class="help-block alert alert-danger"><?= form_error('current_password') ?></span> 
                                        <?php
                                        } ?>
                                        <?php if($this->session->flashdata('update_error')){?> 
                                        <span class="help-block alert alert-danger"><?= $this->session->flashdata('current_password') ?></span> 
                                        <?php
                                        } ?>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="confirm_current_password" id="confirm_current_password" tabindex="2" class="form-control" placeholder="Confirm Current Password">
